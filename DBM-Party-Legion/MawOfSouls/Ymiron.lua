...
local timerDarkSlashCD				= mod:NewCDTimer(18.8, 193211, nil, "Tank", nil, 5, nil, DBM_CORE_TANK_ICON)
...
local timerAriseFallenCD			= mod:NewCDTimer(17.2, 193566, nil, nil, nil, 1, nil, DBM_CORE_HEROIC_ICON)

function mod:OnCombatStart(delay)
	timerDarkSlashCD:Start(4.2-delay)
	timerScreamsCD:Start(8.8-delay)
