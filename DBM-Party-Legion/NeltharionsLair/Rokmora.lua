...
--TODO: maybe add don't move for crystalline ground
local warnShatter					= mod:NewSpellAnnounce(188114, 2)
local warnRazorShards				= mod:NewSpellAnnounce(188169, 4)
...
local timerShatterCD				= mod:NewCDTimer(24, 188114, nil, nil, nil, 2)
local timerRazorShardsCD			= mod:NewCDTimer(29, 188169, nil, "Tank", nil, 5)

local countdownShatter				= mod:NewCountdown(24, 188114, nil, nil, 5)

function mod:OnCombatStart(delay)
	timerShatterCD:Start(20-delay)
	countdownShatter:Start(20-delay)
	timerRazorShardsCD:Start(25.4-delay)
end
