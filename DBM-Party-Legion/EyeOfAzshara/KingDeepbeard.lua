...
local timerQuakeCD					= mod:NewCDTimer(21, 193152, nil, nil, nil, 2)--21-25
local timerCallSeasCD				= mod:NewNextTimer(30, 193051, nil, nil, nil, 2)
local timerGroundSlamCD				= mod:NewCDTimer(18, 193093, nil, "Tank", nil, 5, nil, DBM_CORE_TANK_ICON)--18-30
...
function mod:OnCombatStart(delay)
	timerGroundSlamCD:Start(5-delay)
	timerBubblesCD:Start(10-delay)
	timerQuakeCD:Start(20-delay)
