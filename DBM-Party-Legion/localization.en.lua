...
L:SetMiscLocalization({
	RPVandros = "Enough! You little beasts are getting out of hand!"
})
...
L:SetOptionLocalization({
	...
	warnSpy = "Show warning when the spy is detected",
...
L:SetMiscLocalization({
	proshlyapMurchalRP = "How utterly predictable! I knew that you would come."
})
