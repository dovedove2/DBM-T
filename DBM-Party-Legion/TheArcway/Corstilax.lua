...
local specWarnQuarantine			= mod:NewSpecialWarningTarget(195804, nil, nil, nil, 1, 2)
...
local timerQuarantineCD				= mod:NewNextTimer(47, 195804, nil, nil, nil, 3)
local timerCleansingCD				= mod:NewNextTimer(47, 196115, nil, nil, nil, 2)

mod:AddSetIconOption("SetIconOnQuarantine", 195791)

function mod:OnCombatStart(delay)
	timerSupressionCD:Start(5.5-delay)
	timerQuarantineCD:Start(22-delay)
