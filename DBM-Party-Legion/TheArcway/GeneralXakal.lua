...
local timerFissureCD				= mod:NewCDTimer(24, 197776, nil, nil, nil, 3)--Maybe 23 now?
local timerSlashCD					= mod:NewCDTimer(24, 212030, nil, nil, nil, 3, nil, DBM_CORE_DEADLY_ICON)--25-30
local timerSlamCD					= mod:NewCDTimer(48, 197810, nil, nil, nil, 2)--Possibly 40 but delayed by ICD triggering
...
function mod:SPELL_CAST_START(args)
	...
	elseif spellId == 212030 then
		specWarnBat:Schedule(8.5)
		specWarnBat:ScheduleVoice(8.5, "mobsoon")
		specWarnSlash:Show()
