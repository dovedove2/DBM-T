...
local timerBreathCD					= mod:NewCDTimer(14, 199332, nil, "Tank", nil, 5)--15/20 alternating? need more logs to confirm
local timerEarthShakerCD			= mod:NewCDTimer(25, 199389, nil, nil, nil, 3)
local timerDownDraftCD				= mod:NewCDTimer(30, 199345, nil, nil, nil, 2)--30-42 (health based or varaible?)

function mod:OnCombatStart(delay)
	timerBreathCD:Start(14-delay)
	timerEarthShakerCD:Start(21-delay)
	timerDownDraftCD:Start(25-delay)
end
