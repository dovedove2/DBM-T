...
mod:RegisterEventsInCombat(
	"SPELL_CAST_START 204611 204666 204646 204574 204667"
)
...
local timerThrowCD					= mod:NewCDTimer(34, 204658, nil, nil, nil, 3)--29-32
local timerRootsCD					= mod:NewCDTimer(24, 204574, nil, nil, nil, 3)--23-31
local timerBreathCD					= mod:NewCDTimer(35, 204667, nil, "Tank", nil, 5, nil, DBM_CORE_TANK_ICON)--26--35
...
function mod:OnCombatStart(delay)
	...
	timerThrowCD:Start(32-delay)
	countdownThrow:Start(32-delay)
end
