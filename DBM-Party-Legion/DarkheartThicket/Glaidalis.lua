...
local timerRampageCD			= mod:NewCDTimer(28, 198379, nil, "Tank", nil, 5, nil, DBM_CORE_TANK_ICON)
local timerNightfallCD			= mod:NewCDTimer(28, 198401, nil, nil, nil, 3)
...
function mod:OnCombatStart(delay)
	...
	timerRampageCD:Start(14-delay)
	timerNightfallCD:Start(25-delay)
end
