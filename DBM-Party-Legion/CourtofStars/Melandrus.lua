...
local timerSurgeCD					= mod:NewCDTimer(12, 209602, nil, nil, nil, 3)
local timerMaelstromCD				= mod:NewCDTimer(24, 209676, nil, nil, nil, 3)
local timerGaleCD					= mod:NewCDTimer(24, 209628, nil, nil, nil, 2)

local trashmod = DBM:GetModByName("CoSTrash")

--Surge no longer has a target acquired
--[[ 
...
function mod:OnCombatStart(delay)
	timerGaleCD:Start(11-delay)
	timerMaelstromCD:Start(23-delay)
...
function mod:SPELL_CAST_START(args)
	...
	if spellId == 209602 then
		timerSurgeCD:Start()
		--self:BossTargetScanner(104218, "SurgeTarget", 0.05, 8, true, nil, nil, nil, true)
